...
public class Config {
    public static void init(FileConfiguration config) {
        ...
        config.addDefault("overclaims_per_day", 8); config.set("overclaims_per_day", Collections.singletonList("The amount of townblocks a town can overclaim in a day, resets at new day"));
